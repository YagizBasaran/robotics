...
#Include: '../rai-robotModels/scenarios/simpleArm2.g'
#Include: '../rai-robotModels/scenarios/simplear.g'

#ATTENTION: INCLUDE type is now different (do not use above one, use below one instead!)
